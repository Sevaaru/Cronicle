            ...
            data: (aside) => Column(
              ...
              children: [
                ...
                _HomeGamesCarouselSection(
                  ...
                  slug: GamesHomeSectionSlug.bestRated,
                  items: aside.bestRated,
                  previewCount: _previewCount,
                ),
                _HomeGamesCarouselSection(
                  title: l10n.gamesHomeIndiePicks,
                  slug: GamesHomeSectionSlug.indie,
                  items: aside.indiePicks,
                  previewCount: _previewCount,
                ),
                _HomeGamesCarouselSection(
                  title: l10n.gamesHomeHorrorPicks,
                  slug: GamesHomeSectionSlug.horror,
                  items: aside.horrorPicks,
                  previewCount: _previewCount,
                ),
                _HomeGamesCarouselSection(
                  title: l10n.gamesHomeMultiplayer,
                  slug: GamesHomeSectionSlug.multiplayer,
                  items: aside.multiplayerHits,
                  previewCount: _previewCount,
                ),
                _HomeReviewsSection(
