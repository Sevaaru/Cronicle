...
String _searchFilterTitle(String id, AppLocalizations l10n) => switch (id) {
      'all' => l10n.filterAll,
      'anime' => l10n.filterAnime,
      'manga' => l10n.filterManga,
      'movie' => l10n.filterMovies,
...
class SearchFilterLayoutEditorPage extends ConsumerWidget {
  const SearchFilterLayoutEditorPage({super.key});
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton(
            onPressed: () async {
              await ref.read(searchFilterLayoutProvider.notifier).reset();
              if (context.mounted) {
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text(l10n.settingsLayoutResetDone)),
                );
            ...
            itemBuilder: (context, i) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  title: Text(_searchFilterTitle(s.id, l10n)),
                  trailing: Switch.adaptive(
                    value: s.visible,
                    onChanged: layout.visibleCount <= 1 && s.visible
                        ? null
